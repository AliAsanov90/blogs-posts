...
class BlogController {
  public getAll = catchAsync(
    async (
      req: RequestWithQuery<BlogSortByFields, BlogSearchQueryFields>,
      res: Response,
    ) => {
      const queryInput = setDefaultSortAndPagination<BlogQueryInput>(
        req.sanitizedQuery,
      )
  ...
  public createPostByBlogId = catchAsync(
    async (
      req: RequestWithBlogIdAndBody<Omit<PostInput, 'blogId'>>,
      res: Response,
    ) => {
  ...
  public create = catchAsync(
    async (req: RequestWithBody<BlogInput>, res: Response) => {
  ...
  public update = catchAsync(
    async (req: RequestWithIdAndBody<BlogInput>, res: Response) => {
